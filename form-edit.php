...
<head>
    ...
    <title>Formulir Edit Siswa SMK Negeri 02 Pekalongan</title>
  ...
  items-center">
   <h1 class="text-[20px] font-extrabold text-white">SMK Negeri 02 Pekalongan<h1>
    ...
    <div class="w-full min-h-[100vh] flex flex-col items-center justify-center">
      <h3 class="text-[32px] font-extrabold text-center px-2 mt-3 mb-3">Formulir Edit Siswa</h3>
      <form action="proses-edit.php" method="POST" class="w-full max-w-[450px]
      ...
      gap-4">
            ...
            <p class="w-full flex flex-col justify-center items-start gap-2">
                ...
                value="<?php echo $siswa['nama'] ?>" class="w-full px-4 py-2
            ...
            <p class="w-full flex flex-col justify-center items-start gap-2">
                ...
                border border-slate bg-white hover:border-slate-600
                hover:bg-blue-200"><?php echo $siswa['alamat']
                ?></textarea>
            </p>
            <p class="w-full flex flex-col justify-center items-start gap-2">
            ...
            <p class="w-full flex flex-col justify-center items-start gap-2">
                ...
                value="<?php echo $siswa['sekolah_asal'] ?>" class="w-full px-4 py-2
                border border-slate bg-white hover:border-slate-600
                hover:bg-blue-200">
            </p>
            <p>
                <input type="submit" value="Simpan"name="simpan" class="px-3 py-2 bg-black text-white rounded cursor-pointer
            hover:bg-[rgb(0,0,0,0.6)] transition-all ease-out duration-300">
            </p>
    </form>
    </div><footer class="footer w-full flex flex-col justify-center items-center px-4 py-12 bg-slate-800">
